...
document.addEventListener('click', function(e) {
  ...
  const answerId = btn.getAttribute('data-board-reply-id');
  const author = btn.getAttribute('data-board-reply-author');
  const text = btn.getAttribute('data-board-reply-text');
  window.setBoardReply(qi, answerId, author, text);
});
